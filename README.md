# RRBackup
Here is the content for a readme.md file based on the PowerShell script you provided.
...
How it Works
Infinite Loop: The script runs in a while ($true) loop, which means it will run continuously until manually stopped.

Backup: Every 5 minutes, the Perform-Backup function is called.
...
Cleanup: After each backup, the Cleanup-OldVersions function is called.
...
Navigate to the directory containing vbackup.ps1.
